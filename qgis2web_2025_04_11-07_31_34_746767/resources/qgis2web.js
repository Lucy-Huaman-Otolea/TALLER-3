...
map.getView().fit([-8760130.075416, -1441033.163631, -7826872.793896, -1167813.468186], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UNIDADES GEOLÓGICAS DE JUNIN</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (24 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@DINA LUCY HUAMAN OTOLEA';
            }
